...
public abstract class ReflectionUtils
{
    ...
    public static Method findMethod(Class<?> clazz, String name, Class... paramTypes)
    {
        ...
        if (name == null)
            throw new IllegalStateException("Method name must not be null");
    ...
    {
        if (src == null)
            throw new IllegalStateException("Source for field copy cannot be null");
        if (dest == null)
            throw new IllegalStateException("Destination for field copy cannot be null");
